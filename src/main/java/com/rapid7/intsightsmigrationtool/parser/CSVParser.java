...
public class CSVParser {
    ...
    /**
     * Parses the input file into a map of customer names to CustomerInput records.
     *
     * @param csv the configured input CVS file
     * @return the map of CustomersInput records.
     */
